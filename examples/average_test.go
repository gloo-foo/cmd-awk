...
func (p averageProgram) Begin(ctx awk.Context) (awk.Context, error) {
	ctx = ctx.SetVar("sum", 0.0)
	ctx = ctx.SetVar("count", 0)
	return ctx, nil
}

func (p averageProgram) Action(ctx awk.Context) (awk.Context, string, bool) {
