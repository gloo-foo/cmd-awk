...
func (beginFails) Begin(ctx command.Context) (command.Context, error) { return ctx, errBoom }
...
func (fieldPrint) Action(ctx command.Context) (command.Context, string, bool) {
	return ctx, ctx.Print(ctx.Field(2), ctx.Field(1)), true
}

func TestAwk_FieldSplitting(t *testing.T) {
	input := run.Input("alice 30\nbob 25\n")
...
func (lineCounter) Begin(ctx command.Context) (command.Context, error) {
	ctx = ctx.SetVar("count", 0)
	return ctx, nil
}

func (lineCounter) Action(ctx command.Context) (command.Context, string, bool) {
	ctx = ctx.SetVar("count", ctx.Var("count").(int)+1)
	return ctx, "", false
}
...
func (fieldCount) Action(ctx command.Context) (command.Context, string, bool) {
	return ctx, fmt.Sprintf("%d", ctx.NF), true
}
